...
##   -> predicted values  :  numerical, min =  435756 , mean =  7472471 , max =  89944933  
##   -> model_info        :  package mlr3 , ver. 0.9.0 , task regression (  default  ) 
##   -> residual function :  difference between y and yhat (  default  )
##   -> residuals         :  numerical, min =  -8690067 , mean =  815.5 , max =  17677700  
...
## 1         _full_model_           1343529 Ranger RF
## 2            value_eur           1343529 Ranger RF
## 3            weight_kg           1404479 Ranger RF
## 4 mentality_aggression           1407975 Ranger RF
## 5            height_cm           1416575 Ranger RF
## 6     movement_balance           1418817 Ranger RF
```
...
## 1 skill_ball_control Ranger RF   5 6713792     0
## 2    skill_dribbling Ranger RF   7 6971978     0
## 3    skill_dribbling Ranger RF  11 6967674     0
## 4    skill_dribbling Ranger RF  12 6966664     0
## 5    skill_dribbling Ranger RF  13 6964620     0
## 6    skill_dribbling Ranger RF  14 6965086     0
```
...
```
##                                         contribution
## Ranger RF: intercept                         7472471
## Ranger RF: movement_reactions = 96          11597284
## Ranger RF: skill_ball_control = 92           6367189
## Ranger RF: attacking_finishing = 94          4774574
## Ranger RF: mentality_positioning = 95        4223256
## Ranger RF: attacking_short_passing = 83      4681996
```
